...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 space-y-12">
      ...
      >
        <p>
          At DigiSafe, we are dedicated to revolutionizing the way you invest in the digital age. We understand the importance of security, trust, and growth when it comes to your financial future.
        </p>
        <p>
        ...
        <p>
          At the core of DigiSafe, we believe in empowering our users with the tools and knowledge they need to make informed investment decisions. Our team of experts is committed to providing you with comprehensive resources, market insights, and personalized guidance to help you navigate the world of digital investments.
        </p>
        <p>
